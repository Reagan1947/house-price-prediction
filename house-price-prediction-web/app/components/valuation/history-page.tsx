...
export function HistoryPage({
  ...
  return (
    <section className="valuation-page-section" aria-labelledby="valuation-history-title">
      <header className="valuation-page-head">
        <h2 className="valuation-page-title" id="valuation-history-title">
          History
        </h2>
        <p className="valuation-page-subtitle">Search historical prediction records and inspect details.</p>
      </header>
