...
class Settings(BaseSettings):
    ...
    MODEL_ARTIFACTS_DIR: str = str(BASE_PATH.parent / 'model-artifacts')

    # FastAPI
    FASTAPI_API_V1_PATH: str = '/api/v1'
    FASTAPI_TITLE: str = 'house-price-prediction-service'
    FASTAPI_VERSION: str = '0.0.1'
    FASTAPI_DESCRIPTION: str = 'House price prediction API'
