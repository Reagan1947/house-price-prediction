...
class CustomResponseCode(CustomCodeBase):
    ...
    HTTP_202 = (202, 'Request accepted')
    HTTP_204 = (204, 'Request succeeded with no content')
    ...
    HTTP_425 = (425, 'Request cannot be processed')
...
class CustomErrorCode(CustomCodeBase):
    ...
    CAPTCHA_ERROR = (40001, 'Invalid captcha')
